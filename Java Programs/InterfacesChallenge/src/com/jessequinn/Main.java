...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Player jesse = new Player("Jesse", 13, 25);
        System.out.println(jesse.toString());
        saveObject(jesse);

        jesse.setHitPoints(8);
        System.out.println(jesse);
        jesse.setWeapon("Swordofallswords");
        saveObject(jesse);
        System.out.println(jesse);
...
//        System.out.println(jesse);
        ...
        saveObject(werewolf);
        // casting to get access to methods within class could also replace ISaveable with Monster class.
